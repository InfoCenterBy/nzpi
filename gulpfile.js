...
function fonstIcon() {
     src(path.src.fonstIcon).pipe(dest(path.build.fonstIcon));
     return src(path.src.fonstIcon).pipe(dest(path.build.fonstIcon));
}
...
let build = gulp.series(
     clean,
     gulp.parallel(js, css, html, images, fonts, audio, fonstIcon, purgecss),
     cssmin
);
